/*=========================================================================
  ...
  Module:    $RCSfile: vtkSimCocoaNSView.mm,v $
...
@implementation vtkSimCocoaNSView
...
//----------------------------------------------------------------------------
- (vtkSimCocoaRenderWindowInteractor *)getInteractor
{
  if (myVTKRenderWindow)
    {
    return (vtkSimCocoaRenderWindowInteractor*)myVTKRenderWindow->GetInteractor();
    }
  else
    {
    return NULL;
...
{
  (void)theRect;
// Usually rendering would be done here, but it must be done
// by the main thread
...
{
  vtkSimCocoaRenderWindowInteractor *interactor = [self getInteractor];
